...
// second form
const table2 = document.getElementById("item-lists");

const tbody2 = table.getElementsByTagName("tbody")[0];

// Load data from localStorage
const savedData2 = JSON.parse(localStorage.getItem("myData")) || [];
savedData2.forEach((data) => {
  insertFormData(data);
});
